...
$generalRulePath = Join-Path $rulesRoot 'general.md'
$ruleSkillCount = @(Get-ChildItem $rulesRoot -File -Filter '*.md' -Recurse | Where-Object { $_.FullName -ne $generalRulePath }).Count
